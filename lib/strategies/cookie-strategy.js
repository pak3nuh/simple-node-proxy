 ...
 *  - redirectOnRegisterUrl If defined, returns 301 status and redirects to URL, else returns 200
...
function CookieStrategy(userOptn){
    ...
    function check(req,res,doneCb){
    	...
    	if(cookies[userOptn.cookieName])
    		return doneCb(null, cookies[userOptn.cookieName] == userOptn.cookieValue);
